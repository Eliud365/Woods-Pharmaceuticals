<x-app-layout>
    <x-slot name="header">Add New Supplier</x-slot>
                ...
                <form action="{{ route('suppliers.store') }}" method="POST">
                    ...
                    <div style="margin-bottom:20px;">
                        ...
                        <textarea name="notes" rows="3"
                            style="width:100%;padding:8px 12px;border:1px solid #dde3ec;border-radius:7px;font-size:13px;color:#1a2740;outline:none;font-family:inherit;resize:vertical;">{{ old('notes') }}</textarea>
                    </div>
                    <div style="display:flex;gap:10px;">
                        <button type="submit"
                            style="background:#1a3557;color:#fff;padding:8px 20px;border-radius:7px;border:none;font-size:13px;font-weight:500;cursor:pointer;">Save Supplier</button>
